...
class EsqueciSenhaPageWidget extends StatefulWidget {
  ...
  static String routeName = 'EsqueciSenhaPage';
  static String routePath = '/esqueciSenhaPage';
...
class _EsqueciSenhaPageWidgetState extends State<EsqueciSenhaPageWidget> {
  ...
  void initState() {
    ...
    _model.txtEmailCadastroTextController ??= TextEditingController();
    _model.txtEmailCadastroFocusNode ??= FocusNode();
  }
            ...
            child: Column(
              ...
              children: [
                Container(
                  width: 330,
                  child: TextFormField(
                    controller: _model.txtEmailCadastroTextController,
                    focusNode: _model.txtEmailCadastroFocusNode,
                    autofocus: false,
                    obscureText: false,
                    ...
                    validator: _model.txtEmailCadastroTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Container(
